...
export default function HomePage() {
  return (
    <main className="bg-white text-gray-900">
      {/* HERO (full-width görsel + koyu overlay + metin) */}
      <section className="relative w-full h-[68vh] sm:h-[72vh] lg:h-[78vh] overflow-hidden">
        <img
          src="/hero-home.jpg"
          alt="Fincity ekibi — danışmanlıkta güven, strateji ve iş birliği"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
          ...
          <p className="mt-4 text-lg sm:text-xl max-w-2xl text-white/90">
