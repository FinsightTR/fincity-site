        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden items-center gap-6 md:flex">
              <a className="text-sm font-medium text-gray-700 hover:text-gray-900" href="#about">Hakkımızda</a>
              <a className="text-sm font-medium text-gray-700 hover:text-gray-900" href="#services">Hizmetlerimiz</a>
              <a className="text-sm font-medium text-gray-700 hover:text-gray-900" href="#news">Gündem</a>
              <a
                href="#contact"
      ...
      <section id="news" className="scroll-mt-24 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {/* Örnek kartlar – içerikleri istediğin gibi düzenle */}
            <article className="rounded-2xl border bg-white p-6 shadow-sm">
              <p className="text-xs text-gray-500">2025-10-23</p>
              <h3 className="mt-1 text-lg font-semibold">Finansal planlamada hızlı kazanımlar</h3>
              <p className="mt-2 text-sm text-gray-600">
                FP&A’de 4 haftalık kurulum ve standart dashboard yaklaşımımız.
              </p>
            </article>
            <article className="rounded-2xl border bg-white p-6 shadow-sm">
              <p className="text-xs text-gray-500">2025-10-15</p>
              <h3 className="mt-1 text-lg font-semibold">ERP seçimi için pratik kontrol listesi</h3>
              <p className="mt-2 text-sm text-gray-600">
                Bulut ERP seçiminde 7 kriter: kapsam, raporlama, toplam sahip olma maliyeti…
              </p>
            </article>
          </div>
        </div>
