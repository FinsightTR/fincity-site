      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
            Finansal, operasyonel ve teknolojik ihtiyaçlarınıza uygun entegre çözümler.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-lg font-semibold mb-2">Dijital Hizmetler</h3>
              <p className="text-sm text-gray-600">
                RPA/low-code otomasyon, ERP/CRM entegrasyonları, veri ambarı ve dashboard çözümleri.
              </p>
              <span className="inline-block mt-4 text-sm font-medium">İncele →</span>
            </Link>
            ...
            <Link
              ...
              className="block p-6 bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition"
            >
              <h3 className="text-lg font-semibold mb-2">Vergi Danışmanlığı</h3>
              <p className="text-sm text-gray-600">
                Beyannameler, inceleme süreçleri ve stratejik vergi planlamasıyla tam kapsamlı danışmanlık.
              </p>
              <span className="inline-block mt-4 text-sm font-medium">İncele →</span>
            </Link>
            ...
            <Link
              ...
              className="block p-6 bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition"
            >
              <h3 className="text-lg font-semibold mb-2">Tüm Hizmetler</h3>
              <p className="text-sm text-gray-600">
                Tüm hizmetlerimizi keşfedin — finansal, dijital ve operasyonel çözümler.
              </p>
              <span className="inline-block mt-4 text-sm font-medium">İncele →</span>
            </Link>
          </div>
